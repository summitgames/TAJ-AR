...
public class AutoFlip : MonoBehaviour
{
	...
	{
		StartCoroutine("StartBookAnimation");
	}

	private void OnDisable()
	{
		StopCoroutine("StartBookAnimation");
	}

	IEnumerator StartBookAnimation()
	{
	...
	public void FlipLeftPage()
	{
		Debug.Log(ControledBook.CurrentPaper);
		if (isPageFlipping) return;
		if (ControledBook.CurrentPaper <= 1)
		{
			StartBookFlip = true;
			return;
		}
