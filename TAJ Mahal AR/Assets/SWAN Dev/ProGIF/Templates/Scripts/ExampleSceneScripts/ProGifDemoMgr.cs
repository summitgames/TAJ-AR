...
{
    public bool m_PingPongPreview = false;
    ...
    {
        Debug.Log("Preview the GIF immediately.");
    ...
    public void ShowGifPreviewAndSharePanel(string gifPath, bool loadFile)
    {
        ...
        ProGifManager.Instance.m_GifPlayer.SetOnPlayingCallback((gifTex) =>
        {
            ...
            //if (m_Image)
            //{
            //    m_Image.sprite = gifTex.GetSprite_OptimizeMemoryUsage(ref _refTexture2d);
            //}
        });
    }
