...
public class ProGifControlPanel : MonoBehaviour
{
	...
	public void OnButtonRecordClicked()
	{
		...
		Close(()=>{
			...
			Debug.Log("Start Recording - dropdown_Rotation.value: " + dropdown_Rotation.value + " - " + _GetRotation(dropdown_Rotation.value) + " | Transparent Color: " + ProGifManager.Instance.m_TransparentColor.ToString());
