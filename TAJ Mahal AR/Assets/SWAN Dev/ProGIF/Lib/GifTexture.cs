...
public class GifTexture
{
    ...
    /// <summary>
    /// Lock the color data so it will not be cleared.
    /// </summary>
    ...
    public Texture2D GetTexture2D()
    {
        if (m_texture2d != null)
        {
            //Debug.Log(_optimizeMemoryUsage + " (GetTexture2D) " + (m_Colors == null ? "Color data is cleared!" : "Color data: " + m_Colors.Length));
            return m_texture2d;
        }
        else
        {
    ...
    public Sprite GetSprite()
    {
        ...
        // Clear un-used color array
        if (!_optimizeMemoryUsage && !m_LockColorData) m_Colors = null;
        //Debug.Log(_optimizeMemoryUsage + " - (GetSprite) " + (m_Colors == null ? "Color data is cleared!" : "Color data: " + m_Colors.Length));
